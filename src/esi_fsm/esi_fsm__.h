...
typedef int (*)(TYPE_ALIAS##_state_ptr_t, TYPE_ALIAS##_event_ptr_t, TYPE_ALIAS##_state_ptr_t) \
esi_fsm_##STATE_MEM_T##_##EVENT_ARG_T##_trans_func_t;\
...
TYPE_ALIAS##_ptr_t;\
/* methods for fsm */\
int esi_fsm_add_state(TYPE_ALIAS##_ptr_t, int /* state_id */);\
int esi_fsm_add_event(TYPE_ALIAS##_ptr_t, int /* state_id */, int /* event_id */, TYPE_ALIAS##_trans_func_t);\
int esi_fsm_trans(TYPE_ALIAS##_ptr_t, TYPE_ALIAS##_event_ptr_t);

#define ESI_FSM_TYPE_DECL(TYPE_ALIAS, STATE_MEM_T, EVENT_ARG_T, STATE_LIST_CAP, EVENT_LIST_CAP, TRANS_LIST_CAP) \
int esi_fsm_add_state(TYPE_ALIAS##_ptr_t p_fsm, int state_id) {\
    /** \
     * algorithm: \
...
int esi_fsm_add_event(TYPE_ALIAS##_ptr_t p_fsm, int state_id, int event_id, TYPE_ALIAS##_trans_func_t func) {\
...
int esi_fsm_trans(TYPE_ALIAS##_ptr_t p_fsm, TYPE_ALIAS##_event_ptr_t p_event) {\
    /**\
